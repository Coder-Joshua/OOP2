...
<body class="w3-content" style="max-width: 1200px">
	...
	<div class="w3-main" style="margin-left: 250px">
		...
		<div class="w3-display-container w3-container">
			<img src="Images/banner1.jpg" alt="Electro"	style="max-width: 1200px; width: 100%">
			<div class="w3-display-topleft w3-text-white" style="padding: 24px 48px">
				<h1 class="w3-jumbo w3-hide-small">Large Collection of Electronics</h1>
				<h1 class="w3-hide-large w3-hide-medium">Large Collection of Electronics</h1>

				<p>
					<a href="" class="w3-button w3-black w3-padding-large w3-large">SHOP NOW</a>
				</p>
			</div>
		</div>
		...
		<div class="w3-row">
			<div class="w3-col l3 s6">
				<div class="w3-container w3-button">
					<img src="Images/Asus1.jpg" alt="Asus" style="max-width: 100%; width: 100%; height: auto;">
					<p>
				...
				<div class="w3-container w3-button">
					<img src="Images/HP-Omen.jpeg" style="max-width: 100%; width: 100%; height: auto;">
					<p>
